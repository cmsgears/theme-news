	...
	<tr>
		<td>
			<div style="background: #ffffff; border-top-left-radius: 5px; border-top-right-radius: 5px; margin-left: auto; margin-right: auto; margin-top: -20px; margin-bottom: 0; padding: 10px; text-align: center;width: 80%;">
				...
				<p style="font-size: 14px; font-family: Arial; color: #7f8995; margin:0"> Your account was created at <?=$siteName?> by the site admin. Your account details are as mentioned below: </p>
				<div style="height: 20px"> </div>

				<div style="margin-left: auto; margin-right: auto; display: inline-block">
					<p style="font-size: 14px; font-family: Arial; color: #7f8995; margin:0; text-align: left"> Email: <?=$email?> </p>
					<p style="font-size: 14px; font-family: Arial; color: #7f8995; margin:0; text-align: left"> Activation Link: <?=$email?> <a style="text-decoration: underline; color:#d380b1" href="<?=$confirmLink?>">Activate Account</a> </p>
					<p style="font-size: 14px; font-family: Arial; color: #7f8995; margin:0; text-align: left"> Sincerely, </p>
					<p style="font-size: 14px; font-family: Arial; color: #7f8995; margin:0; text-align: left"> <?=$siteName?> Team </p>
				</div>

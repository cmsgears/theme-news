	...
	<tr>
		<td>
			<div style="background: #ffffff; border-top-left-radius: 5px; border-top-right-radius: 5px; margin-left: auto; margin-right: auto; margin-top: -20px; margin-bottom: 0; padding: 10px; text-align: center;width: 80%;">
				...
				<p style="font-size: 14px; font-family: Arial; color: #7f8995; margin:0"> Reset password request was initiated for your account. Your account details are as mentioned below: </p>
				...
				<div style="margin-left: auto; margin-right: auto; display: inline-block">
					...
					<p style="font-size: 14px; font-family: Arial; color: #7f8995; margin:0; text-align: left"> Reset Link: <a style="text-decoration: underline; color:#d380b1" href="<?=$resetLink?>">Reset Password</a> </p>
				</div>

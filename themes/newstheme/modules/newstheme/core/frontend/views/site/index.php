    ...
    <div class="row padding padding-medium">
        <marquee>This is basic example of marquee</marquee>
            <div class="absolute absolute-top-left  " > 
                <div class="colf colf10x8 padding padding-medium bkg bkg-secondary">
...
<?php BasicBlock::begin([
	'options' => [ 'id' => 'landing-slider-block', 'class' => 'block padding padding-medium' ],
    'contentClass' => 'content-90 clearfix',
    'content' => true,
    'bkg' => true,
    'bkgClass' => 'bkg bkg-white',
    ...
    <div class="col col12x6 align align-center">
         <div class="content-80 ">
            ...
            <div class="row max-cols-50">
               <div class="col col12x5 margin margin-medium color-twitter align align-center text text-white">
                  ...
                  <div class=" colf colf12x3 align align-center color-facebook fa fa-facebook fa-2x padding padding-medium"> </div>
               </div>    
                 <div class="col col12x5 margin margin-medium color-twitter align align-center text text-white">
                  ...
                  <div class="colf colf12x3 align align-center color-twitter fa fa-twitter fa-2x padding padding-medium"> </div>
               </div>  
                 <div class="col col12x5 margin margin-medium color-twitter align align-center text text-white">
                  <div class="colf colf12x9 "> <div class="font-size font-size-large-3 " >11125</div> <div class=""font-size font-size-small>LIKES</div> </div>
                  <div class="colf colf12x3 align align-center color-google-plus fa fa-google-plus fa-2x padding padding-medium"> </div>
               </div>  
                 <div class="col col12x5 margin margin-medium color-twitter align align-center text text-white">
                  <div class="colf colf12x9 "> <div class="font-size font-size-large-3 " >11125</div> <div class=""font-size font-size-small>LIKES</div>  </div>
                  <div class="colf colf12x3 align align-center color-instagram fa fa-instagram fa-2x padding padding-medium"> </div>
               </div>  
            </div> 

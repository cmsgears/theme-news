	...
	<div class="row ">
		<div class="col col12x6">
			...
			<?= CategoryAutoBox::widget([
				...
				'mapActionUrl' => "core/post/assign-category?slug=$model->slug&model-type=$model->type&typed=true",
				'deleteActionUrl' => "core/post/remove-category?slug=$model->slug&model-type=$model->type&typed=true",
